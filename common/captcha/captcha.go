...
func DriverStringFunc() (id, b64s string, err error) {
	...
	//e.DriverString = base64Captcha.NewDriverString(46, 140, 2, 2, 4, "234567890abcdefghjkmnpqrstuvwxyz", &color.RGBA{240, 240, 246, 246}, FontsStorage, []string{"wqy-microhei.ttc"})
	e.DriverString = base64Captcha.NewDriverString(46, 140, 2, 2, 4, "234567890abcdefghjkmnpqrstuvwxyz", &color.RGBA{240, 240, 246, 246}, FontsStorage, []string{"wqy-microhei.ttc"})
	driver := e.DriverString.ConvertFonts()
	capc := base64Captcha.NewCaptcha(driver, base64Captcha.DefaultMemStore)
	return capc.Generate()
}
